...
const Home: NextPage = () => {
  return (
    <div className="bg-white pb-6 sm:pb-8">
      <section className="mx-auto mt-36 max-w-screen-2xl px-4 sm:mt-10 md:px-8">
        <div className="mb-20 flex flex-wrap justify-between md:mb-16">
          <div className="mb-12 flex w-full flex-col justify-center text-purple-800 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
            <h1 className="mb-8  text-6xl font-bold">TimeHive</h1>
        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div className="flex items-center justify-center gap-4 lg:justify-start">
            <div className="flex gap-4">
              <a
                href="https://github.com/crane74/TimeHive"
                target="_blank"
